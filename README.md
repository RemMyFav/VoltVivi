...
- **High energy but low happiness**: Vivi is agitated😠.
- **High energy and high happiness**: Vivi is excited 😄.
- **Low energy and low happiness**: Vivi is depressed 😢.
- **Low energy but high happiness**: Vivi is clam 😴.

![Emotion Category](/assets/README/EmotionCategory.png)
## Features ✨
...
![Development Workflow](/assets/README/VoltViviWorkFlow.png)
